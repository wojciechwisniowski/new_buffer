...
for f in vents_tst.h vents.h termometry_tst.h termometry.h rest_tst.h rest.h test.h minunit.h driver2015mock.h power_tariffs.h power_tariffs_tst.h
do
...
for x in vents_tst.cpp vents.cpp termometry_tst.cpp termometry.cpp rest_tst.cpp rest.cpp test.cpp driver2015mock.cpp power_tariffs.cpp power_tariffs_tst.cpp
do
