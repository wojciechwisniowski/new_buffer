...
void restDebug(Request *a){
 ...
 char * test_request_set_used_vent_speed1() {
	vents_test_init();
    mu_assert((char* )"getDesiredWentRPM(USED_WENT) != 90 - after init", getDesiredWentRPM(USED_WENT) == 90); //ci_defaultNewRPM =100
 ...
 char * test_request_set_new_vent_airing_speed1() {
 	vents_test_init();
     mu_assert((char* )"getDesiredAiringVentRPM(NEW_WENT) != 160 - after init", getDesiredAiringVentRPM(NEW_WENT) == 160);
 ...
 char * test_request_set_used_vent_airing_speed1() {
 	vents_test_init();
     mu_assert((char* )"getDesiredAiringVentRPM(USED_WENT) != 140 - after init", getDesiredAiringVentRPM(USED_WENT) == 140);
